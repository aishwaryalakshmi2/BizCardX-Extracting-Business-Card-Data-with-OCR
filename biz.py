...
mydb=mysql.connector.connect(
    user='root',
    host='localhost',
    password='aishu',auth_plugin='mysql_native_password')
...
if selected == "Contact":
    name = " R P AISHWARYA LAKSHMI "
    mail = (f'{"Mail :"}  {"aishwaryaprem1@gmail.com"}')
    description = "An DATA-SCIENTIST..!"
    social_media = {
        "GITHUB": "https://github.com/aishwaryalakshmi2",
        "LINKEDIN": "https://www.linkedin.com/in/aishwarya-lakshmi-ramadoss-premkumar-8b768a278/"}
